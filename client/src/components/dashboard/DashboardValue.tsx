...
export const DashboardValue = ({ valueData, total }: ValueWidgetProps) => {
    return (
        <div className="bg-white dark:bg-[#1E2630] rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-800 mb-6">
            <div className="mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                {valueData.map((item) => {
                    ...
                    return (
                        <div
                            key={item.name}
                            className="relative overflow-hidden rounded-lg border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-all group"
                        >
                            {/* Colored top border */}
