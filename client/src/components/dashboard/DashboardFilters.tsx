...
export const DashboardFilters: React.FC<DashboardFiltersProps> = ({
    ...
    const hasActiveFilters = selectedLeads.length > 0 || selectedQuarters.length > 0;
    ...
    return (
        <div className="bg-white dark:bg-[#1E2630] p-4 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 flex flex-wrap items-end gap-4 mb-6">
            ...
            <div className="flex-1 flex justify-end items-center">
                <p className="text-[10px] text-gray-400 dark:text-gray-500 italic text-right">
                    * Los datos de todos los widgets se filtran automáticamente al seleccionar un responsable o trimestre.
                </p>
            </div>
        </div>
    );
